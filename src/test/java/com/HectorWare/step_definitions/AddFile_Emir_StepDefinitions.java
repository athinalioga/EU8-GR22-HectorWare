...
public class AddFile_Emir_StepDefinitions {

    AddFile_EmirPage addFileEmirPage = new AddFile_EmirPage();
    ...
    public void user_should_see_the_uploaded_file_on_the_screen() {
        ...
        Web_Utils.waitForVisibility(addFileEmirPage.upTo10MBfileAudio,5);
    ...
    public void user_should_see_the_valid_document_files_on_the_screen() {
        Web_Utils.waitForVisibility(addFileEmirPage.validDocumentFile,5);
