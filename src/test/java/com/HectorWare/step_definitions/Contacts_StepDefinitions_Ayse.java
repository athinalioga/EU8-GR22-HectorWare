...
import com.HectorWare.pages.ContactsFunctionalityPageAyse;
import com.HectorWare.pages.ContactsFunctionalityPageAyse;
...
public class Contacts_StepDefinitions_Ayse {

    ContactsFunctionalityPageAyse contactsFunctionalityPage = new ContactsFunctionalityPageAyse();
...
//        Driver.getDriver().findElement(By.xpath("//input[@type='submit']")).click();
    ...
    public void user_enters_into_the_name_input_box(String fullName) {
        contactsFunctionalityPage.contactFullNameInputBox.clear();
        contactsFunctionalityPage.contactFullNameInputBox.sendKeys(fullName);
    }
